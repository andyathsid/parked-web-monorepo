                    ...
                    <div class="col-lg-10">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-8">
                                    <p class="lead text-muted">
                                        Pada halaman ini, Anda dapat memasukkan data untuk ketiga jenis tes screening Parkinson yang didukung oleh ParkED.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-4">
                                <div class="test-card h-100">
                                    ...
                                    <div class="test-card-content">
                                        <h4>Gambar Spiral</h4>
                                        <p>Evaluasi kontrol motorik halus melalui analisis pola gambar spiral Archimedes.</p>
                            ...
                            <div class="col-lg-4">
                                <div class="test-card h-100">
                                    ...
                                    <div class="test-card-content">
                                        <h4>Rekaman Suara</h4>
                                        <p>Analisis pola suara untuk mendeteksi tremor vokal dan perubahan dalam kemampuan berbicara.</p>
                                        <div class="test-card-stats">
                                            <div class="stat">
                        ...
                        <div class="info-note mt-5">
                            <div class="d-flex align-items-center">
                                ...
                                <p class="mb-0">
                                    Anda dapat memilih untuk mengunggah salah satu, dua, atau ketiga jenis data untuk memperoleh hasil yang lebih komprehensif.
                                </p>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="text-center mb-4">
                                        <div class="card border-warning">
                                            <div class="card-body">
                                                ...
                                                <p class="card-text">
                                                    Tes ini bertujuan untuk mendeteksi tanda-tanda awal tremor atau ketidakstabilan motorik 
                                                    melalui analisis pola gambar spiral. Ikuti langkah-langkah di bawah ini untuk menyelesaikan tes gambar spiral.
                                                </p>
                                                <a href="https://arxiv.org/abs/2111.10207" 
                                            ...
                                            <div class="formdiagnosa-diagnosis-content instruction-section">
                                                ...
                                                <div class="instruction-card">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="instruction-content">
                                                            ...
                                                            <p>Unduh dan cetak template spiral pada kertas A4 putih. Pastikan hasil cetakan jelas dan tidak buram.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="instruction-card">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="instruction-content">
                                                            ...
                                                            <p>Gunakan pulpen biru untuk mengikuti pola spiral dengan perlahan dan teliti, dari pusat atau sebaliknya.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="instruction-card">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="instruction-content">
                                                            <h6>Dokumentasi</h6>
                                                            <p>Ambil foto hasil gambar dengan jelas, pastikan seluruh bagian spiral terlihat dalam frame.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="instruction-card">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="instruction-content">
                                                            <h6>Unggah Hasil</h6>
                                                            <p>Unggah foto hasil gambar spiral Anda pada area yang disediakan di bawah ini.</p>
                                                        </div>
                                                    </div>
                                                </div>

                                                <div class=" mt-2">
                                                    <a href="assets/templates/spiral-template.pdf" class="btn btn-warning text-black">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="text-center mb-4">
                                        <div class="card border-warning">
                                            <div class="card-body">
                                                ...
                                                <p class="card-text">
                                                    Tes ini menggunakan rekaman suara Anda untuk menganalisis pola bicara dan mendeteksi kemungkinan adanya tremor vokal 
                                            ...
                                            <div class="formdiagnosa-diagnosis-content instruction-section">
                                                ...
                                                <div class="instruction-card">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="instruction-content">
                                                            ...
                                                            <p>Unggah file rekaman mandiri atau gunakan fitur rekam langsung melalui mikrofon perangkat Anda.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="instruction-card">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="instruction-content">
                                                            <h6>Baca Teks</h6>
                                                            <p>Bacalah teks yang disediakan dengan perlahan dan jelas di ruangan yang tenang.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="instruction-card">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="instruction-content">
                                                            ...
                                                            <p>Unggah file atau akhiri rekaman langsung setelah selesai membaca teks.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card mt-4 border-warning">
                                        <div class="card-body">
                                            ...
                                            “Hal ini terjadi karena hamburan cahaya biru lebih sedikit karena panjang jalur atmosfer dan tingkat hamburan radiasi yang masuk berkurang. Dengan alasan yang sama, matahari tampak lebih putih dan kurang berwarna oranye seiring dengan peningkatan ketinggian pengamat. Hal ini terjadi karena proporsi sinar matahari yang lebih besar datang langsung ke mata pengamat. Gambar 5.7 adalah representasi skematik dari jalur energi elektromagnetik dalam spektrum tampak saat bergerak dari matahari ke Bumi dan kembali lagi menuju sensor yang dipasang pada satelit yang mengorbit. Jalur gelombang yang mewakili energi yang rentan terhadap hamburan (yaitu, panjang gelombang yang lebih pendek) saat bergerak dari matahari ke Bumi ditunjukkan. Bagi sensor, tampaknya seluruh energi tersebut telah dipantulkan dari titik P di permukaan tanah padahal, kenyataannya, tidak sepenuhnya demikian, karena sebagian energi telah tersebar di dalam atmosfer dan tidak pernah mencapai permukaan tanah sama sekali.”
                                    ...
                                    <div class="text-center mb-4">
                                        <div class="card border-warning">
                                            <div class="card-body">
                                                ...
                                                <p class="card-text">
                                                    Tes ini dirancang khusus untuk membantu tenaga ahli dalam menganalisis citra DaTscan, sebuah teknik pencitraan yang umum digunakan dalam menilai aktivitas dopamin pada otak pasien, sebagai bagian dari upaya deteksi awal Parkinson.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12 mb-4">
                                            <div class="card border-warning">
                                                ...
                                                <div class="card-body">
                                                    <p>Tes ini diperuntukkan bagi pasien yang memenuhi kriteria berikut, berdasarkan ketentuan yang diadaptasi dari Parkinson’s Progression Markers Initiative (PPMI):</p>
                                                    <h6 class="fw-bold mb-3">Kriteria Pasien:</h6>
                                                    <div class="d-flex mb-3">
                                                        <i class="fas fa-check-circle text-warning me-3 mt-1"></i>
                                                        <p class="mb-0">Minimal dua gejala: tremor saat istirahat, bradikinesia, atau kekakuan otot; ATAU tremor/bradikinesia asimetris.</p>
                                                    </div>
                                                    <div class="d-flex mb-3">
                                                        <i class="fas fa-check-circle text-warning me-3 mt-1"></i>
                                                        <p class="mb-0">Diagnosis Parkinson dalam 2 tahun atau kurang.</p>
                                                    </div>
                                                    <div class="d-flex">
                                                        <i class="fas fa-check-circle text-warning me-3 mt-1"></i>
                                                    ...
                                                    <a href="https://tech.snmjournals.org/content/47/1/27" 
                                                       class="btn btn-link text-warning p-0 mt-3"
                                                       target="_blank"
                                                       rel="noopener noreferrer">
                                        ...
                                        <div class="col-12 mb-4">
                                            <div class="card border-warning">
                                                ...
                                                <div class="card-body">
                                                    <p class="card-text" style="text-align: justify;">DaTscan adalah prosedur pencitraan medis yang membantu dokter untuk memahami apakah gejala yang Anda alami terkait dengan penurunan sel dopamin di otak. Dopamin adalah zat kimia penting yang membantu otak mengendalikan gerakan tubuh. Pada penyakit Parkinson, sel-sel dopamin ini rusak atau hilang, sehingga mengakibatkan kesulitan dalam bergerak, seperti gemetar, kekakuan, atau masalah keseimbangan.</p>
                                                    <p class="card-text" style="text-align: justify;">Melalui DaTscan, dokter dapat melihat aktivitas sel dopamin dan menentukan apakah gejala yang Anda alami mungkin disebabkan oleh masalah ini. Tes ini hanya bisa dilakukan dengan resep dokter, jadi jika Anda merasa memiliki gejala tersebut, diskusikan dengan dokter untuk mengetahui apakah DaTscan sesuai untuk Anda.</p>
